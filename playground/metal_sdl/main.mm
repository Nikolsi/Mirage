...
// w/o CMake: cc main.mm `sdl2-config --cflags --libs`
// -framework Metal -framework QuartzCore && ./a.out
//
...
int main(int argc, char *args[]) {
  ...
  SDL_Window *window =
      SDL_CreateWindow("SDL Metal", -1, -1, 640, 480, SDL_WINDOW_ALLOW_HIGHDPI);
  SDL_Renderer *renderer =
      SDL_CreateRenderer(window, -1, SDL_RENDERER_PRESENTVSYNC);
  const CAMetalLayer *swapchain =
